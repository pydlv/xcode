...
class PythonGeneratorTest {
    ...
    fun `test generating print hello world`() {
        ...
        val actualCode = PythonGenerator().generateWithNativeMetadata(ast).code // Changed: Instantiate PythonGenerator
    ...
    fun `test generating simple addition expression`() {
        ...
        val actualCode = PythonGenerator().generateWithNativeMetadata(moduleAst).code // Changed: Instantiate PythonGenerator
