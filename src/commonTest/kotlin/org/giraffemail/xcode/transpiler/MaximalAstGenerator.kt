...
object MaximalAstGenerator {
        ...
        return ModuleNode(
            body = listOf(
                FunctionDefNode(
                    ...
                    body = listOf(
                        ReturnNode(value = null) // void return
                    ),
                    decoratorList = emptyList(),
                    metadata = mapOf(
                        "returnType" to "void",
    ...
    /**
     * Generates a function with return value
     */
        ...
        return ModuleNode(
            body = listOf(
                FunctionDefNode(
                    name = "getValue",
                    args = listOf(
                        NameNode(id = "base", ctx = Param, metadata = mapOf("type" to "string"))
                    ),
                    body = listOf(
                        ReturnNode(
                            value = BinaryOpNode(
                                left = NameNode(id = "base", ctx = Load),
                                op = "+",
                                right = ConstantNode("_processed")
                            )
                        )
                    ),
                    decoratorList = emptyList(),
                    metadata = mapOf(
                        "returnType" to "string",
                        "paramTypes" to mapOf("base" to "string")
                    )
                )
            )
        )
